...
public class MainActivity extends Activity {
	...
	public
	TabHost m_TabHost;
	ToggleButton tgbtn_light,tgbtn_fan,tgbtn_egg;
		...
		public void handleMessage(Message msg) {// 此方法在ui线程运行
			...
			if(msg.what!=UDP_Receiver.FLAG_ERR){
				...
				case UDP_Receiver.FLAG_LIGHT_ON:
					...
					break;
				case UDP_Receiver.FLAG_FAN_ON:
					tgbtn_fan.setChecked(true);
					tgbtn_fan.setText("关闭风扇");
					break;
				case UDP_Receiver.FLAG_EGG_ON:
					tgbtn_egg.setChecked(true);
					tgbtn_egg.setText("关闭榨汁");
					break;
				case UDP_Receiver.FLAG_FAN_OFF:
					tgbtn_fan.setChecked(false);
					tgbtn_fan.setText("打开风扇");
					break;
				case UDP_Receiver.FLAG_EGG_OFF:
					tgbtn_egg.setChecked(false);
					tgbtn_egg.setText("打开榨汁");
					break;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tgbtn_light.setText("打开台灯");
		tgbtn_fan=(ToggleButton)findViewById(R.id.tgbtn_fan);
		tgbtn_fan.setText("打开风扇");
		tgbtn_egg=(ToggleButton)findViewById(R.id.tgbtn_egg);
		tgbtn_egg.setText("打开榨汁");
		...
		tgbtn_fan.setOnClickListener(new OnClickListener(){
			@Override
			public void onClick(View v) {
				String str_send="",str_show="";
				
				if (UDP_Receiver.isFOn) {
					str_send = "FOFF\0";
					str_show = "关风扇";
					tgbtn_fan.setChecked(true);
					tgbtn_fan.setText("关闭风扇");
		...
		tgbtn_egg.setOnClickListener(new OnClickListener(){
			@Override
			public void onClick(View v) {
				String str_send="",str_show="";
				
				if (UDP_Receiver.isEOn) {
					str_send = "EOFF\0";
					str_show = "关榨汁";
					tgbtn_egg.setChecked(true);
					tgbtn_egg.setText("关闭榨汁");
